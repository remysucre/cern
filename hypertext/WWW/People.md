...
This is a list of some of those who have contributed to the [WWW project](https://cern.la/hypertext/WWW/TheProject.md)
...
or look them up in the [phone book](http://crnvmc.cern.ch./WHO) . Address: 1211 Geneva 23, Switzerland.
See also: [Wizards at SLAC](http://slacvm.slac.stanford.edu:80/FIND/wizards.html) .
...
Tim started the [WorldWideWeb](https://cern.la/hypertext/WWW/TheProject.md) project at CERN in 1989. He wrote the[application on the NeXT](https://cern.la/hypertext/WWW/NeXT/WorldWideWeb.md) along with most of the communications software.
...
the future. He wrote a [DTD for HTML](https://cern.la/hypertext/WWW/MarkUp/HTML.dtd) and an [HTML legalizer](https://cern.la/hypertext/WWW/Tools/HTMLGeneration/fix-html.pl) for old
...
problems in making a large amount of information in the [DESY database](http://crnvmc.cern.ch/FIND/DESY)
available.
...
He wrote the [gateway to the VMS Help system](https://cern.la/hypertext/WWW/VMSHelp/Overview.md) , worked on the new modular
...
but continues his interest in the web...( [Contact](https://cern.la/hypertext/WWW/People/Groff.md) )

## Tony Johnson

Tel: (415) 926 2278, TONYJ@scs.slac.stanford.edu.

Designer of [MidasWWW](https://cern.la/hypertext/WWW/Status.md#60) . Boston University, collaborating with SLAC,
SSC, etc. A SLAC server expert and a [WWWizard](http://slacvm.slac.stanford.edu:80/FIND/wizards.html) .

## Paul Kunz

Paul took the W3 word across to SLAC, installed the clients and inspired
the setting up of servers by the [WWWizards](http://slacvm.slac.stanford.edu:80/FIND/wizards.html) . Paul spreads enthusiasm
for all sort of good ideas such as OO programming, NeXTs, etc...

## Willem van Leeuwen

at NIKHEF, WIllem put up many [servers](http://nic.nikhef.nl./user/a03/www/default/NikhefGuide.html) and has provided much useful
...
original [line mode browser](https://cern.la/hypertext/WWW/LineMode/Browser.md) . ( [More](https://cern.la/hypertext/WWW/People/Pellow.md)  ) Nicola is now (Oct 92) working
on the [Mac browser](https://cern.la/hypertext/WWW/Macintosh/Status.md) .
...
He has contributed [code](https://cern.la/hypertext/WWW/Status.md#17) for the FIND server which allows hypertext
...
first [W3-Oracle gateway](https://cern.la/hypertext/WWW/Daemon/Oracle/Overview.md) .
...
one of the [WWWizards](http://slacvm.slac.stanford.edu:80/FIND/wizards.html) at SLAC, Bebo enthusiastically spreads the word.
