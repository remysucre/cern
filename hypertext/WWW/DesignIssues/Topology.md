...
for enhancing the information content of the database. See also:[Private overlaid web](https://cern.la/hypertext/WWW/DesignIssues/Multiuser.md#3) , [Generic Links](https://cern.la/hypertext/Products/Microcosm/Microcosm.md#GenericLinking) .
...
linked web. See [Building Back-links](https://cern.la/hypertext/WWW/DesignIssues/BuildingBackLinks.md).
...
therefore suggest a many-to-one mapping. [JFG](https://cern.la/hypertext/WWW/People.md#groff) disagrees and would like
to see a small menu presented to the user if the link was ambiguous.[Microcosm](https://cern.la/hypertext/Products/Microcosm/Microcosm.md) does this.
...
See also a [list of some types](https://cern.la/hypertext/WWW/DesignIssues/LinkTypes.md) . (Should a link be allowed to have
many types? (- [JFG](https://cern.la/hypertext/WWW/People.md#groff) ) I don't think so: that should be represented
by more than one link.(- [TBL](https://cern.la/hypertext/WWW/People.md#BernersLee) ))

Link typing helps with the generation of [graphical overviews](https://cern.la/hypertext/WWW/DesignIssues/Navigation.md#6) , and
with [automatic tracing](https://cern.la/hypertext/WWW/DesignIssues/TracingLinks.md) .
...
the user interface. If you have a fast [graphic overview](https://cern.la/hypertext/WWW/DesignIssues/Navigation.md#6) , this could
remove the necessity for a preview function.