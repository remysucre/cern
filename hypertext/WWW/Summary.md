...
The [WWW](https://cern.la/hypertext/WWW/TheProject.md) project merges the techniques of information retrieval and
...
to the documents found. A simple protocol (" [HTTP](https://cern.la/hypertext/WWW/Protocols/HTTP/AsImplemented.md) ") is used to allow
...
Making a web is as simple as writing a few [SGML](https://cern.la/hypertext/WWW/MarkUp/MarkUp.md) files which point
to your existing data. Making it public involves running the FTP or
HTTP [daemon](https://cern.la/hypertext/WWW/Daemon/Overview.md) , and making at least one link into your web from another.
...
and Thinking Machine's "W.A.I.S." systems.
...
standards to make full use of them across the web.
...
You can try the simple [line mode browser](https://cern.la/hypertext/WWW/LineMode/Browser.md) by telnetting to info.cern.ch
(no user or password. From UK JANET, use the
[Gateway](https://cern.la/hypertext/WWW/JANETAccess.md)).
You can also find out more about WWW in this
way. This is the least sophisticated browser -- remember that the
window-oriented ones are much smarter!
...
FTP from node info.cern.ch [currently 128.141.201.74] as
 /pub/www/src/WWWLineMode\_v.vv.tar.Z.
(v.vv is the version number - take the latest.)

Also available is a [hypertext editor](https://cern.la/hypertext/WWW/NeXT/WorldWideWeb.md) for the NeXT (WWWNeXTStepEditor\_v.vv.tar.Z),
the ViolaWWW browser for X11, and a skeleton server daemon (WWWDaemon\_v.vv.tar.Z).
...
documentation and articles are in /pub/www/doc

\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
[Tim BL](https://cern.la/WWW/disclaimer.md)